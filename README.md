# Odule Ayanfeoluwa – Senior Frontend Architect Portfolio
...
- **Email Service**: [EmailJS](https://www.emailjs.com/) (Integrated via Server Actions)

## 🏗 Project Structure

- `src/components/index/`: Main landing page sections (Hero, Projects, Experience, Skills).
- `src/components/projects/`: Specialist visual components for different system architectures.
- `src/components/projects/data.tsx`: Centralized data store for project descriptions and gallery assets.
- `public/demos/`: Source for project screenshots and technical visual assets.
